...
namespace Gestao_Patrimonial.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            //Department d4 = new Department(4, "Books"); // or Department { Id = 4, Name = "Books"}
            ...
            SalesRecord r1 = new SalesRecord { Date = new DateTime(2021, 09, 25), Amount = 11000.0, Status = SalesStatus.Billed, Seller = s1 };
            SalesRecord r2 = new SalesRecord { Date = new DateTime(2021, 09, 4), Amount = 7000.0, Status = SalesStatus.Billed, Seller = s5 };
